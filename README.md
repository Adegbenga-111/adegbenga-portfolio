...
I build real-world, production-style projects that simulate operational responsibilities such as access control, secure networking, incident investigation, and system reliability. I am actively seeking an **entry-level Cloud Support or Junior Cloud Engineer role**, with a long-term interest in cloud security.
...
* AWS: EC2, VPC, IAM, S3, CloudFront, DynamoDB
* Secure public and private subnet design
* Bastion host and NAT gateway architectures
* Decoupled web and database deployments
...
* SSH and permission-related access troubleshooting
* Network connectivity and routing diagnosis
...
Secure VPC architecture with structured CIDR planning, public and private subnets, bastion host access, NAT gateway routing, and least-privilege security groups.
...
Simulated enterprise network secured using FortiGate firewall policies, NAT configuration, and routing control.
...
I am building toward a career in **cloud operations and security-focused infrastructure**, with an emphasis on system reliability, access control, and incident response. My goal is to grow from a Cloud Support or Junior Cloud Engineer role into cloud security or platform engineering responsibilities.
